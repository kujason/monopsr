...
def build(optimizer_config,
    ...
    if optimizer_type == 'rms_prop_optimizer':
        optimizer_config = optimizer_config.rms_prop_optimizer
        optimizer = tf.train.RMSPropOptimizer(
            _create_learning_rate(optimizer_config,
                                  global_summaries,
                                  global_step),
        ...
        optimizer_config = optimizer_config.momentum_optimizer
        ...
        optimizer_config = optimizer_config.adam_optimizer
        ...
        optimizer_config = optimizer_config.gradient_descent
...
def _create_learning_rate(optimizer_config,
                          global_summaries,
                          global_step):
    """Create optimizer learning rate based on config.

    Args:
        optimizer_config: A LearningRate proto message.
        global_summaries: A set to attach learning rate summary to.
    ...
    """
    learning_rate = None
    learning_rate_type = optimizer_config.learning_rate_type
    if learning_rate_type == 'constant_learning_rate':
        ...
        learning_rate = tf.train.exponential_decay(
            ...
            optimizer_config.decay_factor,
            staircase=optimizer_config.staircase)

    if learning_rate is None:
        raise ValueError('Learning rate {} not supported.'.format(learning_rate_type))
