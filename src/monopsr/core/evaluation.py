...
def mask_iou(mask1, mask2):
    ...
    Args:
        mask1 (ndarray): mask of shape [H, W]
        mask2 (ndarray): mask of shape [H, W]

    Returns: IoU of the two masks
...
def two_d_iou(box, boxes):
    """Compute 2D IoU between a 2D bounding box and an array of 2D boxes

    Args:
        box: a numpy array in the form of [x1, y1, x2, y2] where (x1,y1) are
        ...
        boxes: a numpy array of shape (N, 4) where N is the number of boxes

    Returns: a numpy array containing 2D IoUs between box and every element
