...
import monopsr
import monopsr.builders.config_builder_util as config_builder
from monopsr.builders.dataset_builder import DatasetBuilder
from monopsr.builders import optimizer_builder
from monopsr.core.models.rpn_model import RpnModel
from monopsr.core.models.avod_model import AvodModel
from monopsr.core import trainer
    ...
    def test_load_model_weights(self):
        ...
        with tf.Graph().as_default():
            ...
            with tf.Session() as sess:
                ...
                checkpoint_utils.load_checkpoints(rpn_checkpoint_dir,
                                                  saver)
                checkpoint_to_restore = saver.last_checkpoints[-1]

                checkpoint_utils.load_model_weights(model,
                                                    sess,
